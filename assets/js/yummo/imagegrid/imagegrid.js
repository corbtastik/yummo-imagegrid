...
const ImageGrid = function(name) {
  ...
  // Marker for keyHandler function
  this.openImageIndex = -1
  // ImageId format
  this.imageId = this.imageGridId + "-image-" + "{0}"
}
...
// ImageGrid.prototype.keyHandlers = function() {
//   window.document.addEventListener("keydown", event => {
//     if (event.key === "ArrowLeft" || (event.key === "<" && event.shiftKey)) {
//       Utils.log("ImageGrid " + this.name + " keydown ArrowLeft clicked.")
//       if(this.openImageIndex > -1) {
//         this.closeImage()
//         this.openImage(this.imageId.format(this.openImageIndex - 1))
//       }
//     } else if (event.key === "ArrowRight" || (event.key === ">" && event.shiftKey)) {
//       Utils.log("ImageGrid " + this.name + " keydown ArrowRight clicked.")
//       if(this.openImageIndex > -1) {
//         this.closeImage()
//         this.openImage(this.imageId.format(this.openImageIndex + 1))
//       }
